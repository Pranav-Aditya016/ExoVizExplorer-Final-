  ...
  return (
    ...
    >
      ...
      <mesh ref={surfaceRef}>
        ...
        {surfaceMaterial && <primitive object={surfaceMaterial} attach="material" />}
      </mesh>
  ...
  useEffect(() => {
    ...
    const surfaceMat = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        time: { value: 0 },
        emissive: { value: new THREE.Color(planet.isTidallyLocked ? '#FF4500' : '#000000') },
        emissiveIntensity: { value: planet.isTidallyLocked ? 0.2 : 0 }
      }
    });
  ...
  useEffect(() => {
    ...
    const cloudsMat = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        opacity: { value: planet.hasIce ? 0.7 : 0.5 },
        time: { value: 0 },
